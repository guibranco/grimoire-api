...
{
    Task<List<AppEnvironment>> GetByApplicationAsync(Guid applicationId, CancellationToken ct = default);
    Task<AppEnvironment?> GetBySlugAsync(Guid applicationId, string slug, CancellationToken ct = default);
